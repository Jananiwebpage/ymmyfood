...
<AiOutlineMenu size={25} />
                ...
                <div className='bg-gray-200 rounded-full flex items-center px-[12px] w-[200px] sm:w-[400px] lg:w-[500px]'>
                    <AiOutlineSearch size={25}/>
                    <input className='bg-transparent p-2 w-full focus: outline-none'
                    type='text' placeholder='search meals'></input>

                </div>

                <button className='bg-orange-700 text-white hidden 
                md:flex items-center p-2 rounded-full text-bold'> <BsFillCartFill size={20}/> 
                cart </button>
               {
                sideNav ? (
